        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnServerId = table.Column<int>(nullable: true),
                    CameraOn = table.Column<bool>(nullable: true),
                    UserPP = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerImage = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(nullable: true),
                    Header = table.Column<string>(maxLength: 45, nullable: true),
                    Text = table.Column<string>(maxLength: 245, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fooorms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fooorms_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InboxMessages_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InboxMessages_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(nullable: true),
                    Text = table.Column<string>(nullable: true),
                    FooormId = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FooormAnswers", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FooormAnswers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FooormAnswers_FooormId",
                table: "FooormAnswers",
                column: "FooormId");

            migrationBuilder.CreateIndex(
                name: "IX_FooormAnswers_UserId",
                table: "FooormAnswers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Fooorms_UserId",
                table: "Fooorms",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InboxMessages_FromUserId",
                table: "InboxMessages",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InboxMessages_ToUserId",
                table: "InboxMessages",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerMembers_ChannelId",
                table: "ServerMembers",
                column: "ChannelId");
