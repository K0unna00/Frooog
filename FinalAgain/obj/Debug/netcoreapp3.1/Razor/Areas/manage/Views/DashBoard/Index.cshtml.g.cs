#pragma checksum "C:\Users\Baxtiyar\Desktop\Frooog\FinalAgain\Areas\manage\Views\DashBoard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9cc37aa70da21f48c00e53d40820a3875f952d9b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9cc37aa70da21f48c00e53d40820a3875f952d9b", @"/Areas/manage/Views/DashBoard/Index.cshtml")]
    ...
    <div class=""row"">
                ...
                <div class=""col-lg-5 col-sm-5"">
                    <div class=""card  mb-2"">
                        <div class=""card-header p-3 pt-2"">
                            <div class=""icon icon-lg icon-shape bg-gradient-dark shadow-dark shadow");
            WriteLiteral(@" text-center border-radius-xl mt-n4 position-absolute"">
                    ...
                    <div class=""card  mb-2"">
                     ...
                     ");
            WriteLiteral(@"           <i class=""material-icons opacity-10"">leaderboard</i>
                            </div>
                            <div class=""text-end pt-1"">
                ...
                <div class=""col-lg-5 col-sm-5 mt-sm-0 mt-4"">
                    <div class=""card  mb-2"">
                        <div class=""card-header p-3 pt-2 bg-transparent"">
                            <div class=""icon icon-lg icon-shape bg-gradient-success shadow-success text-center border-radius-xl mt-n4 position-absolu");
            WriteLiteral(@"te"">
                    ...
                    <div class=""card "">
                        <div class=""card-header p-3 pt-2 bg-transparent"">
                            <div class=""icon icon-lg icon-shape bg-gradient-info shadow-info text-center border-radius-xl mt-n4 position-absolute"">
                                <i class=""material-icons opacity-10"">person_");
            WriteLiteral(@"add</i>
                            </div>
                            <div class=""text-end pt-1"">
     ...
     ");
            WriteLiteral(@"                       <h6 class=""mt-3 mb-2 ms-3 "">Sales by Country</h6>
                        </div>
                        <div class=""card-body p-3"">
                            <div class=""row"">
    ...
    <div class=""row mt-4"">
       ");
            ...
            <div class=""card z-index-2 mt-4"">
              ...
              ");
            WriteLiteral(@"                          <i class=""material-icons opacity-10"">groups</i>
                                    </div>
            ...
            WriteLiteral(@"           </div>
                            ...
                            <div class=""col-3 py-3 ps-0"">
                                <div class=""d-flex mb-2"">
                                    ...
                                    <p class=""text-xs mt-1 mb-0 font-weight-");
            WriteLiteral(@"bold"">Sales</p>
                                </div>
                            ...
                            <div class=""col-3 py-3 ps-0"">
                                ...
                                <h4 clas");
            WriteLiteral(@"s=""font-weight-bolder"">74</h4>
                                <div class=""progress w-75"">
